...
<?php if ($dataapp['maps_use'] == 1) : ?>
    ...
    <?php if (!empty($dataabsensi['maps_absen']) && $dataabsensi['maps_absen'] != 'No Location') : ?>
        ...
        <a class="btn btn-primary my-2" href="https://osm.org/go/tbSBktFEf?node=4329590715<?= $dataabsensi['maps_absen']; ?>" target="_blank"><span class="fas fa-fw fa-map-marker-alt mr-1"></span>Lihat Lokasi</a>
        <script>
