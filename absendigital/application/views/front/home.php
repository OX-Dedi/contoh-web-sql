    ...
    <div class="row mt-3">
        <div class="col-xl-7">
            <div class="card mb-4">
                ...
                <div class="card"
            <div class="card mb-4 col-xl-7 row mt-3">
                <div class="card-header text-center">
                ...
                <div class="card-body">
                    <div class="row detail">
                        <div class="col-md-2 col-sm-4 col-6 p-2">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/L_S6_MfAWmY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    </div>            
                  </div>
                </div>
