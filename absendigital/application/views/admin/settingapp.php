                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <img src="<?= (empty($dataapp['logo_instansi'])) ? base_url('assets/img/TEL-U.png') : (($dataapp['logo_instansi'] == 'default-logo.png') ? base_url('assets/img/TEL-U.png') : base_url('storage/setting/' . $dataapp['logo_instansi'])); ?>" class="img-thumbnail">
                                    </div>
                                    <div class="col-sm-9">
